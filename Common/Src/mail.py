# https://icedhotchoco.tistory.com/entry/sending-email-with-python
...
# 로그인
my_account = config["SMTP"]["smtp_id"]
my_password = config["SMTP"]["smtp_pw"]
smtp.login(my_account, my_password)
 
# 메일을 받을 계정
to_mail = config["SMTP"]["smtp_mail"]
 
# 메일 기본 정보 설정
msg = MIMEMultipart()
msg["Subject"] = f"123"  # 메일 제목
msg["From"] = my_account
msg["To"] = to_mail
